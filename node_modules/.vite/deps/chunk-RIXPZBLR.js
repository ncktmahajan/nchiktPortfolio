...
var createDomVisualElement = (Component3, options) => {
  return isSVGComponent(Component3) ? new SVGVisualElement(options) : new HTMLVisualElement(options, {
    allowProjection: Component3 !== import_react.Fragment
  });
};
...
function useForceUpdate() {
  ...
  const [forcedRenderCount, setForcedRenderCount] = (0, import_react14.useState)(0);
  const forceRender = (0, import_react14.useCallback)(() => {
    isMounted.current && setForcedRenderCount(forcedRenderCount + 1);
  }, [forcedRenderCount]);
  const deferredForceRender = (0, import_react14.useCallback)(() => frame.postRender(forceRender), [forceRender]);
...
var LayoutGroup = ({ children, id: id3, inherit = true }) => {
  const layoutGroupContext = (0, import_react15.useContext)(LayoutGroupContext);
  const deprecatedLayoutGroupContext = (0, import_react15.useContext)(DeprecatedLayoutGroupContext);
  const [forceRender, key] = useForceUpdate();
  const context = (0, import_react15.useRef)(null);
  ...
  const memoizedContext = (0, import_react15.useMemo)(() => ({ ...context.current, forceRender }), [key]);
...
function LazyMotion({ children, features, strict = false }) {
  const [, setIsLoaded] = (0, import_react17.useState)(!isLazyBundle(features));
  const loadedRenderer = (0, import_react17.useRef)(void 0);
...
function MotionConfig({ children, isValidProp, ...config }) {
  ...
  config = { ...(0, import_react18.useContext)(MotionConfigContext), ...config };
  config.isStatic = useConstant(() => config.isStatic);
  const context = (0, import_react18.useMemo)(() => config, [
...
function createUseRender(forwardMotionProps = false) {
  const useRender = (Component3, props, ref, { latestValues }, isStatic) => {
    ...
    const elementProps = Component3 !== import_react28.Fragment ? { ...filteredProps, ...visualProps, ref } : {};
    const { children } = props;
    const renderedChildren = (0, import_react28.useMemo)(() => isMotionValue(children) ? children.get() : children, [children]);
    return (0, import_react28.createElement)(Component3, {
      ...elementProps,
...
//# sourceMappingURL=chunk-RIXPZBLR.js.map
